...
// This is the new feature that I added to media player //
// At first, I have been considering between the feature "Fullscreen", "Fast-speed" and "SkipForward"//
// But I want the users to view the video at the specific size and if the video was zoomed out, it will affect to the design of the background// 
// The "Fast-speed" feature is cool but I don't think it is necessary for this video as it's basically a sound video//
// At the end, I chose the "SkipForward" - "SkipBackward" feature as it is the most suitable feature for this video, it enables viewers to skip 
// to the content that I want to hear or rewind the previous part that they have missed without dragging the progress bar //  

/* SkipBackward */
 
skipBackward.addEventListener("click", () => {
   videoElement.currentTime -= 10; // subtract 10s from the current timeline
   skipBackward.style.backgroundImage = "url('./icons/rewind.svg')";
});

/* SkipForward */

skipForward.addEventListener("click", () => {
   videoElement.currentTime += 10; // add 10s to the current timeline
   skipForward.style.backgroundImage = "url('./icons/fastForward.svg')";
